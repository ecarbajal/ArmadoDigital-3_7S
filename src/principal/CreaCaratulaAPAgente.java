...
public class CreaCaratulaAPAgente {
	public static final String plantilla = CtsArmado.pathJar + "Formato AP Agente.pdf";
	public static String pathSal = CtsArmado.pathSal;
	public static final String path = CtsArmado.pathSpool + "Spool_Carat_AP_Agen.txt";

	int contCar = 0;
	int largoArreg = 0;
	String poliza = "";

	public CreaCaratulaAPAgente(String nNegocio) {
	...
	public static void main(String[] args) {
		try{
			CreaCaratulaAPAgente cc = new CreaCaratulaAPAgente("");		
	...
	public boolean creaCaratulaColor(String file) throws IOException, DocumentException{
...
//			br.readLine();
			...
			while(((line = br.readLine()) != null)&&(cont<40) ){
				...
				if(line.length()>0){
					...
					if(line.indexOf("DJD1 FEED='SEGU1',JDE=AZ93,PMODE=POR,DUP=YES,FORM=AZ93,END;")>-1){
						break;
					}
				}else
					datos[cont]="";
	...
	public void creaCaraAP(String[] datos) throws IOException, DocumentException{
		...
		datos[26] = datos[26].replaceAll("S", "s");
		datos[24] = datos[24].replaceAll("¥", "í");
		datos[25] = datos[25].replaceAll("pìliza", "póliza");
		datos[27] = datos[27].replaceAll("x", "áx");
		...
		fl.mkdirs();
		stamper = new PdfStamper(reader, new FileOutputStream(pathSal+ "\\"+poliza+"\\Caratula\\"+"Caratula_AP_Agente"+poliza+".pdf"));
		Phrase phraset = null;
		...
		Chunk c9= new Chunk(datos[6].substring(82, 95).trim(), Arial);
		...
		Chunk c21 = new Chunk(datos[9].substring(0, 48).trim(), Arial); //RAZON SOCIAL
		Chunk c22 = new Chunk(datos[9].substring(48,55).trim(), Arial); // RIESGO
		...
		if(datos[12].substring(0,largoArreg).trim().equals("TEMPORAL")){
			cA23=new Chunk("Plan Contratado: SIGA TEMPORAL",Arial);
		}
		...
		if(largoArreg > 10 && largoArreg < 50){
			...
			c224 = new Chunk();
			c324 = new Chunk();
		} else if (largoArreg > 50 && largoArreg < 76){
			c26 = new Chunk(datos[15].substring(0, 38).trim(), Arial);
		...
		if(largoArreg > 0 && largoArreg < 50){
			cA16 = new Chunk(datos[16].substring(0, largoArreg).trim(), Arial);
			cB16 = new Chunk();
			cC16 = new Chunk();
		} else if (largoArreg > 50 && largoArreg < 76){
		...
		if(largoArreg > 0 && largoArreg < 50){
			cA17 = new Chunk(datos[17].substring(0, largoArreg).trim(), Arial);
			cB17 = new Chunk();
			cC17 = new Chunk();
		} else if (largoArreg > 50 && largoArreg < 76){
		...
		Chunk c38A= new Chunk(datos[27].substring(0, largoArreg).trim(), Arial);
		largoArreg = datos[28].length();
		Chunk c38B= new Chunk(datos[28].substring(0, largoArreg).trim(), Arial);
		largoArreg = datos[29].length();
		Chunk c38C= new Chunk(datos[29].substring(0, largoArreg).trim(), Arial);
		...
		Chunk c49A = new Chunk("");
		Chunk c49B = new Chunk("");
		Chunk c49C = new Chunk("");
		Chunk c49D = new Chunk("");
		Chunk c49E = new Chunk("");
		
		if(largoArreg < 70){
			c49A = new Chunk(datos[36].substring(0, 10).trim(), Arial);
			c49B = new Chunk(datos[36].substring(11, 27).trim(), Arial);
			c49C = new Chunk(datos[36].substring(28, largoArreg).trim(), Arial);
				
		}else{
		c49A = new Chunk(datos[36].substring(0, 10).trim(), Arial);
		c49B = new Chunk(datos[36].substring(11, 27).trim(), Arial);
		c49C = new Chunk(datos[36].substring(28, 70).trim(), Arial);
		c49D = new Chunk(datos[36].substring(70, 78).trim(), Arial);
		c49E = new Chunk(datos[36].substring(79, largoArreg).trim(), Arial);
		}
		
		
//		
//		datos[41] = datos[41].replaceAll("¥", "í");
//		datos[43] = datos[43].replaceAll("¥", "í");
//
//		
//		Chunk c50 = new Chunk();
//		largoArreg = datos[41].length();
//		c50 = new Chunk(datos[41].substring(0,largoArreg));
//		largoArreg = datos[42].length();
//		Chunk c51 = new Chunk(datos[42].substring(0,largoArreg));
//		largoArreg = datos[43].length();
//		Chunk c52 = new Chunk(datos[43].substring(0,largoArreg));
//		largoArreg = datos[44].length();
//		Chunk c53 = new Chunk(datos[44].substring(0,largoArreg));
//		largoArreg = datos[45].length();
//		Chunk c54 = new Chunk(datos[45].substring(0,largoArreg));
//		largoArreg = datos[46].length();
//		Chunk c55 = new Chunk(datos[46].substring(0,largoArreg));
//		largoArreg = datos[47].length();
//		Chunk c56 = new Chunk(datos[47].substring(0,largoArreg));
//		largoArreg = datos[48].length();
//		Chunk c57 = new Chunk(datos[48].substring(0,largoArreg));
//		largoArreg = datos[49].length();
//		Chunk c58 = new Chunk(datos[49].substring(0,largoArreg));
//		largoArreg = datos[50].length();
//		Chunk c59 = new Chunk(datos[50].substring(0,largoArreg));
//		largoArreg = datos[51].length();
//		Chunk c60 = new Chunk(datos[51].substring(0,largoArreg));
//		largoArreg = datos[52].length();
//		Chunk c61 = new Chunk(datos[52].substring(0,largoArreg));
//		largoArreg = datos[53].length();
//		Chunk c62 = new Chunk(datos[53].substring(0,largoArreg));
//		largoArreg = datos[54].length();
//		Chunk c63 = new Chunk(datos[54].substring(0,largoArreg));
//		largoArreg = datos[55].length();
//		Chunk c64 = new Chunk(datos[55].substring(0,largoArreg));
//		largoArreg = datos[56].length();
//		Chunk c65 = new Chunk(datos[56].substring(0,largoArreg));
//		largoArreg = datos[57].length();
//		Chunk c66 = new Chunk(datos[57].substring(0,largoArreg));
//		largoArreg = datos[58].length();
//		Chunk c67 = new Chunk(datos[58].substring(0,largoArreg));
//		largoArreg = datos[59].length();
//		Chunk c68 = new Chunk(datos[59].substring(0,largoArreg));
//		largoArreg = datos[60].length();
//		Chunk c69 = new Chunk(datos[60].substring(0,largoArreg));
//		largoArreg = datos[61].length();
//		Chunk c70 = new Chunk(datos[61].substring(0,largoArreg));
//		largoArreg = datos[62].length();
//		Chunk c71 = new Chunk(datos[62].substring(0,largoArreg));
//		largoArreg = datos[63].length();
//		Chunk c72 = new Chunk(datos[63].substring(0,largoArreg));
//		largoArreg = datos[64].length();
//		Chunk c73 = new Chunk(datos[64].substring(0,largoArreg));
//		largoArreg = datos[65].length();
//		Chunk c74 = new Chunk(datos[65].substring(0,largoArreg));
//		largoArreg = datos[66].length();
//		Chunk c75 = new Chunk(datos[66].substring(0,largoArreg));
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 330, 635, 0);
		System.out.println("Generando c6: " + phraset);
		phraset = new Phrase(c7);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 373, 635, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 214, 582, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 368, 582, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 512, 582, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 333, 540, 0);
		System.out.println("Generando c22: " + phraset);
		phraset = new Phrase(c921);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 365, 540, 0);
		System.out.println("Generando c921: " + phraset);
		phraset = new Phrase(c922); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 455, 540, 0);
		System.out.println("Generando c922: " + phraset);
		phraset = new Phrase(c23);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 518, 540, 0);
		System.out.println("Generando c23: " + phraset);
		
		phraset = new Phrase(cA23);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 450, 0);
		System.out.println("Generando cA23: " + phraset);
		phraset = new Phrase(c24); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 438, 0);  
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 438, 0);
		System.out.println("Generando cA24: " + phraset);
		phraset = new Phrase(c25);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 426, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 426, 0);
		System.out.println("Generando c125: " + phraset);
		phraset = new Phrase(c26);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 414, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 414, 0);
		System.out.println("Generando c324: " + phraset);
		phraset = new Phrase(cA16);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 402, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 402, 0);
		System.out.println("Generando cC16: " + phraset);
		phraset = new Phrase(cA17);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 390, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 490, 0);
		System.out.println("Generando cC17: " + phraset);
		phraset = new Phrase(cA18);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 378, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 378, 0);
		System.out.println("Generando cC18: " + phraset);
		phraset = new Phrase(cA19);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 366, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 460, 366, 0);
		System.out.println("Generando cC19: " + phraset);
		phraset = new Phrase(cA20);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 354, 0);
		...
		phraset = new Phrase(c38A); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 258, 0);  
		System.out.println("Generando c38A: " + phraset);
		phraset = new Phrase(c38B); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 246, 0);  
		System.out.println("Generando c38B: " + phraset);
		phraset = new Phrase(c38C); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 234, 0);  
		System.out.println("Generando c38C: " + phraset);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 490, 178, 0);  
		System.out.println("Generando c44: " + phraset);
		phraset = new Phrase(c45); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 165, 0);  
		System.out.println("Generando c45: " + phraset);
		phraset = new Phrase(c46); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 147, 165, 0);  
		System.out.println("Generando c46: " + phraset);

//		int ind = 685;
//		phraset = new Phrase(c50); 
//		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 40, ind, 0);  
//		System.out.println("Generando c50: " + phraset);
//		phraset = new Phrase(c51); 
//		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 40, ind=ind-12, 0);  
...
//		
		...
		phraset = new Phrase(c49A); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 55, 75, 0);  
		System.out.println("Generando c49A: " + phraset);
		phraset = new Phrase(c49B); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 120, 75, 0);  
		System.out.println("Generando c49B: " + phraset);
		phraset = new Phrase(c49C); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 220, 75, 0);  
		System.out.println("Generando c49C: " + phraset);
		phraset = new Phrase(c49D); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 450, 75, 0);  
		System.out.println("Generando c49D: " + phraset);
		phraset = new Phrase(c49E); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 510, 75, 0);  
		System.out.println("Generando c49E: " + phraset);
