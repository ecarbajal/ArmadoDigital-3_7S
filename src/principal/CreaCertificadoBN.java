...
public class CreaCertificadoBN {

	public static final String plantilla = CtsArmado.pathJar + "Plantilla GM04 BN.pdf";
	public static final String plantilla2 = CtsArmado.pathJar + "plantilla gm04 bn-001.pdf";
	...
	public CreaCertificadoBN(String nNegocio, String nPoliza) {
	...
	public static void main(String[] args) {
		try{
			CreaCertificadoBN cc = new CreaCertificadoBN("", null);		
			cc.creaCertif(path);
		} catch (Exception e) {			
			e.printStackTrace();
		} 
	...
	public void creaCaraCte(String[] datos) throws IOException, DocumentException{
		...
		if(largoArreg<1){
			...
			c47= new Chunk(datos[13].substring(71, 73).trim(), Arial);       // ANTIGUEDAD GNP
		...
		if(largoArreg<1){
			...
			c79 = new Chunk(datos[50].substring(0, 25), Arial);
		}		
		...
		if(largoArreg>1){
			...
			c79 = new Chunk(datos[56].substring(0, 25), Arial);
		}		
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 23, 700, 0);         
		System.out.println("Generando c0: " + phraset);
		phraset = new Phrase(c1);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 523, 695, 0);   //689
		System.out.println("Generando c1: " + phraset);		
		// Datos Generales
		phraset = new Phrase(c2);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 78, 671, 0);
		System.out.println("Generando c2: " + phraset);
		phraset = new Phrase(c3); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 467, 671, 0); 
		System.out.println("Generando c3: " + phraset);
		phraset = new Phrase(c4); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 78, 648, 0);  
		System.out.println("Generando c4: " + phraset);
		phraset = new Phrase(c5);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 504, 648, 0);
		System.out.println("Generando c5: " + phraset);
		phraset = new Phrase(c6); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 78, 638, 0);
		System.out.println("Generando c6: " + phraset);		
		//Blanco
		phraset = new Phrase(c7);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 78, 628, 0);
		System.out.println("Generando c7: " + phraset);		
		// Asegurados
				phraset = new Phrase(c8); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 562, 0); 
				System.out.println("Generando c8: " + phraset);
				phraset = new Phrase(c9);     
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 562, 0);
				System.out.println("Generando c9: " + phraset);
				phraset = new Phrase(c10); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 562, 0);
				System.out.println("Generando c10: " + phraset);
				phraset = new Phrase(c11);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 562, 0);
				System.out.println("Generando c11: " + phraset);
				phraset = new Phrase(c12); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 562, 0); 
				System.out.println("Generando c12: " + phraset);	
				phraset = new Phrase(c13); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 562, 0); 
				System.out.println("Generando c13: " + phraset);
				phraset = new Phrase(c14);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 541, 562, 0);
				System.out.println("Generando c14: " + phraset);	
				//Planes
				phraset = new Phrase(c15); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 552, 0);
				System.out.println("Generando c15: " + phraset);
				phraset = new Phrase(c16);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 552, 0);
				System.out.println("Generando c16: " + phraset);
				phraset = new Phrase(c17);		
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 552, 0);
				System.out.println("Generando c17: " + phraset);
				phraset = new Phrase(c18);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 552, 0);
				System.out.println("Generando c18: " + phraset);
				phraset = new Phrase(c19); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 552, 0);
				System.out.println("Generando c19: " + phraset);
				phraset = new Phrase(c20);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 552, 0);
				System.out.println("Generando c20: " + phraset);
				phraset = new Phrase(c21);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 552, 0);
				System.out.println("Generando c21: " + phraset);
				phraset = new Phrase(c22); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 540, 0);
				System.out.println("Generando c22: " + phraset);
				phraset = new Phrase(c23);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 540, 0);
				System.out.println("Generando c23: " + phraset);
				phraset = new Phrase(c24); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 540, 0);  
				System.out.println("Generando c24: " + phraset);
				phraset = new Phrase(c25);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 540, 0);
				System.out.println("Generando c25: " + phraset);
				phraset = new Phrase(c26);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 540, 0);
				System.out.println("Generando c26: " + phraset);
				phraset = new Phrase(c27);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 540, 0);
				System.out.println("Generando c27: " + phraset);
				phraset = new Phrase(c28);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 540, 0);
				System.out.println("Generando c28: " + phraset);
				
				phraset = new Phrase(c29); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 528, 0);
				System.out.println("Generando c29: " + phraset);
				phraset = new Phrase(c30);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 528, 0);
				System.out.println("Generando c30: " + phraset);
				phraset = new Phrase(c31); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 528, 0);  
				System.out.println("Generando c31: " + phraset);
				phraset = new Phrase(c32);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 528, 0);
				System.out.println("Generando c32: " + phraset);
				phraset = new Phrase(c33);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 528, 0);
				System.out.println("Generando c33: " + phraset);
				phraset = new Phrase(c34);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 528, 0);
				System.out.println("Generando c34: " + phraset);
				phraset = new Phrase(c35);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 528, 0);
				System.out.println("Generando c35: " + phraset);
				
				phraset = new Phrase(c36); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 516, 0);
				System.out.println("Generando c36: " + phraset);
				phraset = new Phrase(c37);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 516, 0);
				System.out.println("Generando c37: " + phraset);
				phraset = new Phrase(c38); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 516, 0);  
				System.out.println("Generando c38: " + phraset);
				phraset = new Phrase(c39);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 516, 0);
				System.out.println("Generando c39: " + phraset);
				phraset = new Phrase(c40);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 516, 0);
				System.out.println("Generando c40: " + phraset);
				phraset = new Phrase(c41);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 516, 0);
				System.out.println("Generando c41: " + phraset);
				phraset = new Phrase(c42);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 516, 0);
				System.out.println("Generando c42: " + phraset);

				phraset = new Phrase(c43); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 504, 0);
				System.out.println("Generando c43: " + phraset);
				phraset = new Phrase(c44);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 504, 0);
				System.out.println("Generando c44: " + phraset);
				phraset = new Phrase(c45); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 504, 0);  
				System.out.println("Generando c45: " + phraset);
				phraset = new Phrase(c46);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 504, 0);
				System.out.println("Generando c46: " + phraset);
				phraset = new Phrase(c47);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 504, 0);
				System.out.println("Generando c47: " + phraset);
				phraset = new Phrase(c48);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 504, 0);
				System.out.println("Generando c48: " + phraset);
				phraset = new Phrase(c49);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 504, 0);
				System.out.println("Generando c49: " + phraset);
				
				phraset = new Phrase(c50); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 20, 491, 0);
				System.out.println("Generando c50: " + phraset);
				phraset = new Phrase(c51);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 80, 491, 0);
				System.out.println("Generando c51: " + phraset);
				phraset = new Phrase(c52); 
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 295, 491, 0);  
				System.out.println("Generando c52: " + phraset);
				phraset = new Phrase(c53);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 376, 491, 0);
				System.out.println("Generando c53: " + phraset);
				phraset = new Phrase(c54);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 449, 491, 0);
				System.out.println("Generando c54: " + phraset);
				phraset = new Phrase(c55);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 479, 491, 0);
				System.out.println("Generando c55: " + phraset);
				phraset = new Phrase(c56);        
				ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 491, 0);
				System.out.println("Generando c56: " + phraset);
		
		
		
		phraset = new Phrase(c57);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 223, 454, 0);
		System.out.println("Generando c57: " + phraset);		
		phraset = new Phrase(c58);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 363, 454, 0);
		System.out.println("Generando c58: " + phraset);
		phraset = new Phrase(c59);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 498, 454, 0);
		System.out.println("Generando c59: " + phraset);
				
		phraset = new Phrase(c60);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 446, 0);
		System.out.println("Generando c60: " + phraset);
		phraset = new Phrase(c61);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 41, 446, 0);
		System.out.println("Generando c61: " + phraset);
		phraset = new Phrase(c62);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 74, 446, 0);
		System.out.println("Generando c62: " + phraset);
		phraset = new Phrase(c63);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 110, 446, 0);
		System.out.println("Generando c63: " + phraset);
		phraset = new Phrase(c64);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 138, 446, 0);
		System.out.println("Generando c64: " + phraset);
		phraset = new Phrase(c65);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 165, 446, 0);
		System.out.println("Generando c65: " + phraset);
				
		phraset = new Phrase(c66);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 417, 0);
		System.out.println("Generando c66: " + phraset);
		phraset = new Phrase(c67);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 222, 417, 0);
		System.out.println("Generando c67: " + phraset);
		phraset = new Phrase(c68);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 363, 417, 0);
		System.out.println("Generando c68: " + phraset);
		phraset = new Phrase(c69);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 510, 417, 0);
		System.out.println("Generando c69: " + phraset);
		
		phraset = new Phrase(c70);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 407, 0);
		System.out.println("Generando c70: " + phraset);
		phraset = new Phrase(c71);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 222, 407, 0);
		System.out.println("Generando c71: " + phraset);
		phraset = new Phrase(c72);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 363, 407, 0);
		System.out.println("Generando c72: " + phraset);
		phraset = new Phrase(c73);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 510, 407, 0);
		System.out.println("Generando c73: " + phraset);		
		
		phraset = new Phrase(c80);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 397, 0);
		System.out.println("Generando c80: " + phraset);
		phraset = new Phrase(c80A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 222, 397, 0);
		System.out.println("Generando c80A: " + phraset);
		
		phraset = new Phrase(c80B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 363, 397, 0);
		System.out.println("Generando c80B: " + phraset);
		
		phraset = new Phrase(c80C);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 510, 397, 0);
		System.out.println("Generando c80C: " + phraset);
		
		
		phraset = new Phrase(c92);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 387, 0);
		System.out.println("Generando c92: " + phraset);
		phraset = new Phrase(c93);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 377, 0);
		System.out.println("Generando c93: " + phraset);
		phraset = new Phrase(c94);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 21, 367, 0);
		System.out.println("Generando c94: " + phraset);
		
		
		phraset = new Phrase(c74);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 14, 312, 0);
		System.out.println("Generando c74: " + phraset);		
		phraset = new Phrase(c75);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 157, 215, 0);
		System.out.println("Generando c75: " + phraset);
		phraset = new Phrase(c75A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 157, 205, 0);
		System.out.println("Generando c75A " + phraset);
		phraset = new Phrase(c75B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 157, 193, 0);
		System.out.println("Generando c76A " + phraset);
		...
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 73, 192, 0);
		System.out.println("Generando c76: " + phraset);
		phraset = new Phrase(c77);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 110, 192, 0);
		System.out.println("Generando c77: " + phraset);
		phraset = new Phrase(c78);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 210, 192, 0);
		System.out.println("Generando c78: " + phraset);
		
		phraset = new Phrase(c79);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 38, 180, 0);
