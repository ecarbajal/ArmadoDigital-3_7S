...
public class CreaCertificadoLAI {

	public static final String plantilla = CtsArmado.pathJar + "Plantilla GM03 Color.pdf";
	...
	String certif ="";
	String certifcom ="";
	public CreaCertificadoLAI(String nNegocio, String nPoliza) {
	...
	public static void main(String[] args) {
		try{
			CreaCertificadoLAI cc = new CreaCertificadoLAI("", null);		
			cc.creaCertif(path);
		} catch (Exception e) {			
			e.printStackTrace();
		} 
	...
	public void creaCaraCte(String[] datos) throws IOException, DocumentException{
		...
		datos[10] = datos[10].replaceAll("#", "Ñ");
		datos[11] = datos[11].replaceAll("#", "Ñ");
		datos[12] = datos[12].replaceAll("#", "Ñ");
		datos[13] = datos[13].replaceAll("#", "Ñ");
		datos[14] = datos[14].replaceAll("#", "Ñ");
		datos[36] = datos[36].replaceAll("#", "Ñ");
		datos[37] = datos[37].replaceAll("#", "Ñ");
		datos[38] = datos[38].replaceAll("#", "Ñ");
		datos[39] = datos[39].replaceAll("#", "Ñ");
		datos[40] = datos[40].replaceAll("#", "Ñ");
		datos[41] = datos[41].replaceAll("#", "Ñ");
		datos[42] = datos[42].replaceAll("#", "Ñ");
		...
		if(largoArreg<1){
			...
			c1A = new Chunk(datos[1].substring(0, largoArreg),Arial);
		}
...
//			c21= new Chunk(datos[8].substring(85, largoArreg).trim(), Arial);	
		...
		if(largoArreg<1){
			...
			c15A= new Chunk(datos[9].substring(0, largoArreg).trim(), Arial);
			c16B= new Chunk();
			c17C= new Chunk();
			c18D= new Chunk();
			c19E= new Chunk();
			...
			c15A= new Chunk(datos[9].substring(0, 9).trim(), Arial);
			c16B= new Chunk(datos[9].substring(9, largoArreg).trim(), Arial);
			c17C= new Chunk();
			c18D= new Chunk();
			c19E= new Chunk();
			c20F= new Chunk();
			...
			c15A= new Chunk(datos[9].substring(0, 9).trim(), Arial);
			c16B= new Chunk(datos[9].substring(9, 45).trim(), Arial);
			c17C= new Chunk(datos[9].substring(45, largoArreg).trim(), Arial);			
			c18D= new Chunk();
			c19E= new Chunk();
			c20F= new Chunk();
			c21G= new Chunk();
			...
			c15A= new Chunk(datos[9].substring(0, 9).trim(), Arial);
			c16B= new Chunk(datos[9].substring(9, 45).trim(), Arial);
			c17C= new Chunk(datos[9].substring(45, 57).trim(), Arial);
			c18D= new Chunk(datos[9].substring(57, largoArreg).trim(), Arial);			
			c19E= new Chunk();
			c20F= new Chunk();
			c21G= new Chunk();
		}else if(largoArreg<74&&largoArreg>67){
			...
			c16B= new Chunk(datos[9].substring(9, 45).trim(), Arial);
			c17C= new Chunk(datos[9].substring(45, 57).trim(), Arial);
			c18D= new Chunk(datos[9].substring(57, 68).trim(), Arial);
			c19E= new Chunk(datos[9].substring(70, largoArreg).trim(), Arial);			
			c20F= new Chunk();
			c21G= new Chunk();
		}else if(largoArreg<87&&largoArreg>74){
			c15A= new Chunk(datos[9].substring(0, 9).trim(), Arial);
			...
			c17C= new Chunk(datos[9].substring(45, 57).trim(), Arial);
			c18D= new Chunk(datos[9].substring(57, 68).trim(), Arial);
			c19E= new Chunk(datos[9].substring(70, 73).trim(), Arial);
			c20F= new Chunk(datos[9].substring(75, largoArreg).trim(), Arial);			
			c21G= new Chunk();
		}else if(largoArreg>86){
			c15A= new Chunk(datos[9].substring(0, 9).trim(), Arial); 			// NOMBRE
			c16B= new Chunk(datos[9].substring(9, 45).trim(), Arial);		// PARENTESCO
			c17C= new Chunk(datos[9].substring(45, 57).trim(), Arial);		// FECHA NACIMIENTO
			c18D= new Chunk(datos[9].substring(57, 71).trim(), Arial);   	// GENERO
			c19E= new Chunk(datos[9].substring(71, 81).trim(), Arial);       // ANTIGUEDAD GNP
			c20F= new Chunk(datos[9].substring(81, largoArreg).trim(), Arial);       // ANTIGUEDAD OTRAS
//			c21= new Chunk(datos[8].substring(85, largoArreg).trim(), Arial);	
			c21G= new Chunk();
...
//			c42= new Chunk(datos[12].substring(85, largoArreg).trim(), Arial);	
		...
		if(largoArreg<1){
			...
			c46= new Chunk(datos[13].substring(58, 71).trim(), Arial);   	// GENERO
			c47= new Chunk(datos[13].substring(71, 81).trim(), Arial);       // ANTIGUEDAD GNP
...
//			c49= new Chunk(datos[13].substring(85, largoArreg).trim(), Arial);	
		...
		if(largoArreg<1){
			...
			c50= new Chunk(datos[14].substring(0, 9).trim(), Arial);
			c51= new Chunk(datos[14].substring(10, 45).trim(), Arial);
			c52= new Chunk(datos[14].substring(46, 58).trim(), Arial);
			c53= new Chunk(datos[14].substring(58, 71).trim(), Arial);
			c54= new Chunk(datos[14].substring(71, 81).trim(), Arial);
			c55= new Chunk(datos[14].substring(81, largoArreg).trim(), Arial);
			c56= new Chunk();
		}else if(largoArreg>86){
			c50= new Chunk(datos[14].substring(0, 9).trim(), Arial); 			// NOMBRE
			c51= new Chunk(datos[14].substring(10, 45).trim(), Arial);		// PARENTESCO
...
//			c56= new Chunk(datos[14].substring(85, largoArreg).trim(), Arial);	
		...
		if(largoArreg<1){
			...
			c57 = new Chunk(datos[15].substring(37, 47).trim(), Arial);
			c58 = new Chunk(datos[15].substring(55, 65).trim(), Arial);
			c59 = new Chunk();
		...
		if(largoArreg<1){
			...
			c92 = new Chunk(datos[19].substring(0, largoArreg).trim(), Arial);
			c92A = new Chunk();
			c92B = new Chunk();
			c92C = new Chunk();
		}else if(largoArreg<55&&largoArreg>29){
			c92 = new Chunk(datos[19].substring(0, 30).trim(), Arial);
			c92A = new Chunk(datos[19].substring(31, largoArreg).trim(), Arial);
			c92B = new Chunk();
			c92C = new Chunk();
		}else if(largoArreg<75&&largoArreg>54){
			c92 = new Chunk(datos[19].substring(0, 30).trim(), Arial);
			c92A = new Chunk(datos[19].substring(31, 53).trim(), Arial);
			c92B = new Chunk(datos[19].substring(53, largoArreg ).trim(), Arial);
			c92C = new Chunk();
		}else{
			c92 = new Chunk(datos[19].substring(0, 30).trim(), Arial);
			c92A = new Chunk(datos[19].substring(31, 53).trim(), Arial);
			c92B = new Chunk(datos[19].substring(53, 74).trim(), Arial);
			c92C = new Chunk(datos[19].substring(75, largoArreg).trim(), Arial);
		}
		...
		if(largoArreg<1) {
			...
			c100=new Chunk(datos[48].substring(0,largoArreg),Arial);
		}
		...
		if(largoArreg<1) {
			...
			c101=new Chunk(datos[49].substring(0,largoArreg),Arial);
		}
		...
		if(largoArreg<1) {
			...
			c102=new Chunk(datos[50].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[51].length();
		if(largoArreg<1) {
			c103=new Chunk();
		}else {
			c103=new Chunk(datos[51].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[52].length();
		if(largoArreg<1) {
			c104=new Chunk();
		}else {
			c104=new Chunk(datos[52].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[53].length();
		if(largoArreg<1) {
			c105=new Chunk();
		}else {
			c105=new Chunk(datos[53].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[54].length();
		if(largoArreg<1) {
			c106=new Chunk();
		}else {
			c106=new Chunk(datos[54].substring(0,largoArreg),Arial);
		}
		...
		if(largoArreg<1) {
			...
			c107=new Chunk(datos[55].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[56].length();
		if(largoArreg<1) {
			c108=new Chunk();
		}else {
			c108=new Chunk(datos[56].substring(0,largoArreg),Arial);
		}
		
		largoArreg = datos[57].length();
		if(largoArreg<1) {
			c109=new Chunk();
		}else {
			c109=new Chunk(datos[57].substring(0,largoArreg),Arial);
		}
		...
		if(largoArreg<10){
			...
			c78A = new Chunk(datos[59].substring(0, 40).trim(), Arial);
			largoArreg = datos[59].length();
		}		
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 33, 689, 0);
		System.out.println("Generando c0: " + phraset);
		phraset = new Phrase(c1A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 33, 677, 0);
		System.out.println("Generando c1A: " + phraset);
		
		phraset = new Phrase(c1); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 514, 689, 0);
		System.out.println("Generando c1: " + phraset);		
		// Datos Generales
		phraset = new Phrase(c2);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 665, 0);
		System.out.println("Generando c2: " + phraset);
		phraset = new Phrase(c3); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 486, 665, 0); 
		System.out.println("Generando c3: " + phraset);
		phraset = new Phrase(c4); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 642, 0);  
		System.out.println("Generando c4: " + phraset);
		phraset = new Phrase(c5);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 525, 642, 0);
		System.out.println("Generando c5: " + phraset);
		phraset = new Phrase(c6); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 632, 0);
		System.out.println("Generando c6: " + phraset);		
		//Blanco
		phraset = new Phrase(c7);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 622, 0);
		System.out.println("Generando c7: " + phraset);		
		
		// Asegurados
		phraset = new Phrase(c8); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 558, 0); 
		System.out.println("Generando c8: " + phraset);
		phraset = new Phrase(c9);     
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 558, 0);
		System.out.println("Generando c9: " + phraset);
		phraset = new Phrase(c10); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 558, 0);
		System.out.println("Generando c10: " + phraset);
		phraset = new Phrase(c11);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 558, 0);
		System.out.println("Generando c11: " + phraset);
		phraset = new Phrase(c12); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 558, 0); 
		System.out.println("Generando c12: " + phraset);	
		phraset = new Phrase(c13); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 558, 0); 
		System.out.println("Generando c13: " + phraset);
		phraset = new Phrase(c14);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 558, 0);
		System.out.println("Generando c14: " + phraset);	
		//Planes
		phraset = new Phrase(c15); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 546, 0);
		System.out.println("Generando c15: " + phraset);
		phraset = new Phrase(c16);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 546, 0);
		System.out.println("Generando c16: " + phraset);
		phraset = new Phrase(c17);		
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 546, 0);
		System.out.println("Generando c17: " + phraset);
		phraset = new Phrase(c18);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 546, 0);
		System.out.println("Generando c18: " + phraset);
		phraset = new Phrase(c19); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 546, 0);
		System.out.println("Generando c19: " + phraset);
		phraset = new Phrase(c20);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 546, 0);
		System.out.println("Generando c20: " + phraset);
		phraset = new Phrase(c21);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 546, 0);
		System.out.println("Generando c21: " + phraset);
		
		phraset = new Phrase(c22); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset,  32, 522, 0);
		System.out.println("Generando c22: " + phraset);
		phraset = new Phrase(c23);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 522, 0);
		System.out.println("Generando c23: " + phraset);
		phraset = new Phrase(c24); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 522, 0);  
		System.out.println("Generando c24: " + phraset);
		phraset = new Phrase(c25);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 522, 0);
		System.out.println("Generando c25: " + phraset);
		phraset = new Phrase(c26);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 522, 0);
		System.out.println("Generando c26: " + phraset);
		phraset = new Phrase(c27);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 522, 0);
		System.out.println("Generando c27: " + phraset);
		phraset = new Phrase(c28);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 522, 0);
		System.out.println("Generando c28: " + phraset);
		
		phraset = new Phrase(c15A);  
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 534, 0);
		System.out.println("Generando c15A: " + phraset);
		phraset = new Phrase(c16B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 534, 0);
		System.out.println("Generando c16B: " + phraset);
		phraset = new Phrase(c17C); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 534, 0);  
		System.out.println("Generando c17C: " + phraset);
		phraset = new Phrase(c18D);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 534, 0);
		System.out.println("Generando c18D: " + phraset);
		phraset = new Phrase(c19E);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 534, 0);
		System.out.println("Generando c19E: " + phraset);
		phraset = new Phrase(c20F);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 534, 0);
		System.out.println("Generando c20F: " + phraset);
		phraset = new Phrase(c21G);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 534, 0);
		System.out.println("Generando c21G: " + phraset);

		
		phraset = new Phrase(c29); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 510, 0);
		System.out.println("Generando c29: " + phraset);
		phraset = new Phrase(c30);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 510, 0);
		System.out.println("Generando c30: " + phraset);
		phraset = new Phrase(c31); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 510, 0);  
		System.out.println("Generando c31: " + phraset);
		phraset = new Phrase(c32);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 510, 0);
		System.out.println("Generando c32: " + phraset);
		phraset = new Phrase(c33);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 510, 0);
		System.out.println("Generando c33: " + phraset);
		phraset = new Phrase(c34);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 510, 0);
		System.out.println("Generando c34: " + phraset);
		phraset = new Phrase(c35);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 510, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 498, 0);
		System.out.println("Generando c37: " + phraset);
		phraset = new Phrase(c38); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 498, 0);  
		System.out.println("Generando c38: " + phraset);
		phraset = new Phrase(c39);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 498, 0);
		System.out.println("Generando c39: " + phraset);
		phraset = new Phrase(c40);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 498, 0);
		System.out.println("Generando c40: " + phraset);
		phraset = new Phrase(c41);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 498, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 486, 0);
		System.out.println("Generando c44: " + phraset);
		phraset = new Phrase(c45); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 486, 0);  
		System.out.println("Generando c45: " + phraset);
		phraset = new Phrase(c46);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 486, 0);
		System.out.println("Generando c46: " + phraset);
		phraset = new Phrase(c47);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 486, 0);
		System.out.println("Generando c47: " + phraset);
		phraset = new Phrase(c48);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 538, 486, 0);
		System.out.println("Generando c48: " + phraset);
		phraset = new Phrase(c49);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 486, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 474, 0);
		System.out.println("Generando c51: " + phraset);
		phraset = new Phrase(c52); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 352, 474, 0);  
		System.out.println("Generando c52: " + phraset);
		phraset = new Phrase(c53);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 431, 474, 0);
		System.out.println("Generando c53: " + phraset);
		phraset = new Phrase(c54);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 474, 0);
		System.out.println("Generando c54: " + phraset);
		phraset = new Phrase(c55);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 540, 474, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 37, 432, 0);
		System.out.println("Generando c60: " + phraset);
		phraset = new Phrase(c61);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 60, 432, 0);
		System.out.println("Generando c61: " + phraset);
		phraset = new Phrase(c62);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 82, 432, 0);
		System.out.println("Generando c62: " + phraset);
		phraset = new Phrase(c63);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 121, 432, 0);
		System.out.println("Generando c63: " + phraset);
		phraset = new Phrase(c64);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 150, 432, 0);
		System.out.println("Generando c64: " + phraset);
		phraset = new Phrase(c65);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 178, 432, 0);
		System.out.println("Generando c65: " + phraset);
				
		///COBERTURAS
		phraset = new Phrase(c66);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 400, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 223, 390, 0);
		System.out.println("Generando c71: " + phraset);
		phraset = new Phrase(c72);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 366, 390, 0);
		System.out.println("Generando c72: " + phraset);
		phraset = new Phrase(c73);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 390, 0);
		System.out.println("Generando c73: " + phraset);		
		
		phraset = new Phrase(c80A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 223, 380, 0);
		System.out.println("Generando c80A: " + phraset);
		
		phraset = new Phrase(c80B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 366, 380, 0);
		System.out.println("Generando c80B: " + phraset);
		
		phraset = new Phrase(c80C);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 380, 0);
		System.out.println("Generando c80C: " + phraset);
		
		phraset = new Phrase(c80);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 380, 0);
		System.out.println("Generando c80: " + phraset);
		
		phraset = new Phrase(c92);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 370, 0);
		System.out.println("Generando c92: " + phraset);
		phraset = new Phrase(c92A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 223, 370, 0);
		System.out.println("Generando c92A: " + phraset);
		
		phraset = new Phrase(c92B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 366, 370, 0);
		System.out.println("Generando c92B: " + phraset);
		
		phraset = new Phrase(c92C);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 505, 370, 0);
		System.out.println("Generando c92C: " + phraset);
		
		phraset = new Phrase(c93);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 360, 0);
		System.out.println("Generando c93: " + phraset);
		phraset = new Phrase(c94);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 35, 350, 0);
		System.out.println("Generando c94: " + phraset);
		phraset = new Phrase(c95);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 70, 199, 0);
		System.out.println("Generando c95: " + phraset);
		phraset = new Phrase(c96);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 99, 199, 0);
		System.out.println("Generando c96: " + phraset);
		phraset = new Phrase(c97);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 191, 199, 0);
		System.out.println("Generando c97: " + phraset);
		phraset = new Phrase(c98);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 35, 186, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 30, 295, 0);
		System.out.println("Generando c74: " + phraset);	
		phraset = new Phrase(c74A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 30, 283, 0);
		System.out.println("Generando c74A: " + phraset);
		phraset = new Phrase(c74B);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 30, 271, 0);
		System.out.println("Generando c74B: " + phraset);
		
		phraset = new Phrase(c75);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 170, 200, 0);
		System.out.println("Generando c75: " + phraset);
		phraset = new Phrase(c75A);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 170, 188, 0);
		System.out.println("Generando c75A: " + phraset);
		
		phraset = new Phrase(c81);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 649, 0);
		System.out.println("Generando c81: " + phraset);

		phraset = new Phrase(c82);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 638, 0);
		System.out.println("Generando c82: " + phraset);

		phraset = new Phrase(c83);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 627, 0);
		System.out.println("Generando c83: " + phraset);

		phraset = new Phrase(c84);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 616, 0);
		System.out.println("Generando c84: " + phraset);

		phraset = new Phrase(c85);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 605, 0);
		System.out.println("Generando c85: " + phraset);

		phraset = new Phrase(c86);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 37, 594, 0);
		System.out.println("Generando c83: " + phraset);

		phraset = new Phrase(c81A);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 649, 0);
		System.out.println("Generando c81A: " + phraset);

		phraset = new Phrase(c81B);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 649, 0);
		System.out.println("Generando c81B: " + phraset);

		phraset = new Phrase(c81C);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 649, 0);
		System.out.println("Generando c81C: " + phraset);

		phraset = new Phrase(c82C);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 638, 0);
		System.out.println("Generando c82C: " + phraset);

		phraset = new Phrase(c83C);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 627, 0);
		System.out.println("Generando c83C: " + phraset);

		phraset = new Phrase(c84C);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 616, 0);
		System.out.println("Generando c84C: " + phraset);

		phraset = new Phrase(c85C);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 605, 0);
		System.out.println("Generando c85C: " + phraset);

		phraset = new Phrase(c86C);        
	    ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 594, 0);
		System.out.println("Generando c86C: " + phraset);
		
	    phraset = new Phrase(c81D);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 649, 0);
		System.out.println("Generando c81D: " + phraset);
		
		phraset = new Phrase(c82D);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 638, 0);
		System.out.println("Generando c82D: " + phraset);
		phraset = new Phrase(c83D);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 627, 0);
		System.out.println("Generando c83D: " + phraset);
		phraset = new Phrase(c84D);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 616, 0);
		System.out.println("Generando c84D: " + phraset);
		phraset = new Phrase(c85D);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 605, 0);
		System.out.println("Generando c85D: " + phraset);
		phraset = new Phrase(c86D);        
	    ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 483, 594, 0);
		System.out.println("Generando c86D: " + phraset);

	    phraset = new Phrase(c82A);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 638, 0);
		System.out.println("Generando c82A: " + phraset);
		phraset = new Phrase(c82B);                
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 638, 0);
		System.out.println("Generando c82B: " + phraset);
		phraset = new Phrase(c83A);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 627, 0);
		System.out.println("Generando c83A: " + phraset);
		phraset = new Phrase(c83B);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 627, 0);
		System.out.println("Generando c83B: " + phraset);
		phraset = new Phrase(c84A);       
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 616, 0);
		System.out.println("Generando c84A: " + phraset);
		phraset = new Phrase(c84B);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 616, 0);
		System.out.println("Generando c84B: " + phraset);
		phraset = new Phrase(c85A);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 605, 0);
		System.out.println("Generando c85A: " + phraset);
		phraset = new Phrase(c85B);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 605, 0);
		System.out.println("Generando c85B: " + phraset);
		phraset = new Phrase(c86A);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 103, 594, 0);
		System.out.println("Generando c86A: " + phraset);
		phraset = new Phrase(c86B);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 407, 594, 0);
		System.out.println("Generando c86B: " + phraset);
		phraset = new Phrase(c89);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 30, 68, 0);
		System.out.println("Generando c89: " + phraset);
		phraset = new Phrase(c90);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 30, 690, 0);
		System.out.println("Generando c90: " + phraset);
		phraset = new Phrase(c91);        
		ColumnText.showTextAligned(canvas2, Element.ALIGN_LEFT, phraset, 30, 700, 0);
		System.out.println("Generando c91: " + phraset);
		
		
		
		phraset = new Phrase(c100);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 490, 0);
		System.out.println("Generando c100: " + phraset);
		phraset = new Phrase(c101);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 478, 0);
		System.out.println("Generando c101: " + phraset);
		phraset = new Phrase(c102);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 466, 0);
		System.out.println("Generando c102: " + phraset);
		phraset = new Phrase(c103);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 454, 0);
		System.out.println("Generando c103: " + phraset);
		phraset = new Phrase(c104);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 442, 0);
		System.out.println("Generando c104: " + phraset);
		phraset = new Phrase(c105);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 430, 0);
		System.out.println("Generando c105: " + phraset);
		phraset = new Phrase(c106);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 418, 0);
		System.out.println("Generando c106: " + phraset);
		phraset = new Phrase(c107);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 406, 0);
		System.out.println("Generando c107: " + phraset);
		phraset = new Phrase(c108);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 394, 0);
		System.out.println("Generando c108: " + phraset);
		phraset = new Phrase(c109);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 40, 382, 0);
		System.out.println("Generando c109: " + phraset);
		...
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 190, 199, 0);
		System.out.println("Generando c78: " + phraset);
		phraset = new Phrase(c78A);        
		ColumnText.showTextAligned(canvas3, Element.ALIGN_LEFT, phraset, 35, 187, 0);
