...
public class CreaCaratulaAPAsegurado {



	
	public static final String plantilla = CtsArmado.pathJar + "Formato AP Asegurado.pdf";
	public static String pathSal = CtsArmado.pathSal;
	public static final String path = CtsArmado.pathSpool + "Spool_Carat_AP_Aseg.txt";

	int contCar = 0;
	int largoArreg = 0;
	String poliza = "";

	public CreaCaratulaAPAsegurado(String nNegocio) {
	...
	public static void main(String[] args) {
		try{
			CreaCaratulaAPAsegurado cc = new CreaCaratulaAPAsegurado("");		
...
//			br.readLine();
	...
	public void creaCaraAP(String[] datos) throws IOException, DocumentException{
		...
		fl.mkdirs();
		stamper = new PdfStamper(reader, new FileOutputStream(pathSal+ "\\"+poliza+"\\Caratula\\"+"Caratula_AP_Asegurado"+poliza+".pdf"));
		Phrase phraset = null;
...
//		}
		...
		Chunk c21 = new Chunk(datos[9].substring(0, 45).trim(), Arial); //RAZON SOCIAL
		...
		if(largoArreg > 0 && largoArreg < 50){
			cA18 = new Chunk(datos[18].substring(0, largoArreg).trim(), Arial);
			cB18 = new Chunk();
			cC18 = new Chunk();
		} else if (largoArreg > 50 && largoArreg < 76){
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 329, 635, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 212, 582, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 343, 582, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 332, 540, 0);
		System.out.println("Generando c22: " + phraset);
		phraset = new Phrase(c921);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 375, 540, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 510, 540, 0);
