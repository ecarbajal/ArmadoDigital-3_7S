...
public class CreaEndosoBN {

	public static final String plantilla = CtsArmado.pathJar + "Plantilla GM11 BN.pdf";
	...
	public CreaEndosoBN(String nNegocio) {
	...
	public static void main(String[] args) {
		try{
			CreaEndosoBN cc = new CreaEndosoBN("");		
			cc.creaEndos(path);
		} catch (IOException e) {			
			e.printStackTrace();
	...
	public void creaEndos(String file) throws IOException, DocumentException{
		...
		while(flag){
			...
			while(((line = br.readLine()) != null)&&((cont<40))){
				if(!line.trim().equals("DJD1 FEED='SEGU1',FORM=GM18,END;")){
					if(line.length()>0){					
						datos[cont]=line.substring(1, line.length());
					}else{
						datos[cont]="";
	...
	public void creaCaraCte(String[] datos) throws IOException, DocumentException{
		...
		if (c342.equals("")) {
			nombreArchivo = (pathSal+"\\"+poliza+"\\endosos\\"+"Endoso Niv-Pol "+endoso+"_"+ c342 + " " + c343+".pdf");
		} else {
			nombreArchivo = (pathSal+"\\"+poliza+"\\endosos\\"+"Endoso Niv-Aseg "+endoso+"_"+ c342 + " " + c343+".pdf");
		}
		...
		Chunk c17 = new Chunk(datos[9].substring(81, largoArreg).trim(), arial);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 32, 695, 0);         
		System.out.println("Generando c0: " + phraset);
		arial.setSize((float) 10);
//		arial.setStyle(1);
		phraset = new Phrase(c1);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 522, 695, 0);         
		System.out.println("Generando c01: " + phraset);

		phraset = new Phrase(c2);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 85, 683, 0);
		System.out.println("Generando c2: " + phraset);

		phraset = new Phrase(c3); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 435, 683, 0); 
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 152, 567, 0); 
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 320, 567, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 520, 515, 0);
		System.out.println("Generando c17: " + phraset);
		//TEXTO DEL ENDOSO
		phraset = new Phrase(c18);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 500, 0); //511
		System.out.println("Generando c18: " + phraset);
		phraset = new Phrase(c018);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 488, 0);
		System.out.println("Generando c018: " + phraset);
		phraset = new Phrase(c019);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 476, 0);
		System.out.println("Generando c019: " + phraset);
		phraset = new Phrase(c19); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 464, 0);
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 440, 0);
		System.out.println("Generando c21: " + phraset);
		phraset = new Phrase(c22); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 428, 0);
		System.out.println("Generando c22: " + phraset);
		phraset = new Phrase(c23);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 416, 0);
		System.out.println("Generando c23: " + phraset);
		phraset = new Phrase(c023);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 404, 0);
		System.out.println("Generando c023: " + phraset);
		phraset = new Phrase(c24); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 392, 0);  
		System.out.println("Generando c24: " + phraset);
		phraset = new Phrase(c25);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 380, 0);
		System.out.println("Generando c25: " + phraset);
		phraset = new Phrase(c025);    
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 368, 0);
		System.out.println("Generando c025: " + phraset);
		phraset = new Phrase(c026);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 356, 0);
		System.out.println("Generando c026: " + phraset);
		phraset = new Phrase(c027);
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 344, 0);
		System.out.println("Generando c027: " + phraset);
		phraset = new Phrase(c028); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 332, 0);
		System.out.println("Generando c028: " + phraset);
		phraset = new Phrase(c029); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 320, 0);
		System.out.println("Generando c029: " + phraset);
		phraset = new Phrase(c030); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 308, 0);
		System.out.println("Generando c030: " + phraset);
		phraset = new Phrase(c031); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 296, 0);
		System.out.println("Generando c031: " + phraset);
		phraset = new Phrase(c032); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 284, 0);
		System.out.println("Generando c032: " + phraset);
		phraset = new Phrase(c033); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 272, 0);
		System.out.println("Generando c033: " + phraset);
		phraset = new Phrase(c034); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 260, 0);
		System.out.println("Generando c034: " + phraset);
		phraset = new Phrase(c035); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 248, 0);
		System.out.println("Generando c035: " + phraset);
		phraset = new Phrase(c036); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 236, 0);
		System.out.println("Generando c036: " + phraset);
		//FIN TEXTO DEL ENDOSO
		phraset = new Phrase(c26); 
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 380, 224, 0);
		System.out.println("Generando c26: " + phraset);
		phraset = new Phrase(c27);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 29, 138, 0);
		System.out.println("Generando c27: " + phraset);
		phraset = new Phrase(c28);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 495, 138, 0);
		System.out.println("Generando c28: " + phraset);
		phraset = new Phrase(c29);        
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, phraset, 550, 138, 0);
